...
of meteorological data and allow for better predictions of demand during daylight. Furthermore, full (T, RH) space could be mapped to see all coordinates yielding demand below assumed threshold. 
